 ...
 * 
 * <p>This class was made to unify trackers which may represent status codes in different formats.
...
public class Statuses {
     ...
     * 
     * <p>For example, calling this method with "plan to read" or "planning" or "PLANNING" will
