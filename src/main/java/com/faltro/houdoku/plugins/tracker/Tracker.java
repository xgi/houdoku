 ...
 * 
 * <p>For this client, we want users to link with a tracker and have their lists be automatically
...
public interface Tracker {
     ...
     * 
     * <p>The {@link #isAuthenticated()} property is updated, if necessary.
     * 
     * <p>This function is particularly useful to check whether any access token is still valid
     * after the client was restarted.
     *
     ...
     * 
     * <p>Requires {@link #isAuthenticated()}.
     *
     ...
     * 
     * <p>If "safe" is true: If the user's number read is greater than the given value, the number
     * on the tracker is not changed.
     *
     * @param id      the series id
