...
public interface ContentSource {
     ...
     * <li>coverSrc (optional) (String) - a URL to an image of the series' cover</li>
     * <li>title (String) - the title of the series</li>
     * <li>details (String) - a generally multiline string which contains the information about the
     * series that will appear in the client's table of search results</li>
     * </ul>
     *
     * @param query the text to search for
     * @return an ArrayList of HashMap's where keys are the field names listed above as Strings and
     *         values of the matching type
     * @throws IOException             an IOException occurred when searching
     * @throws NotImplementedException the operation has not yet been implemented for this content
     *                                 source
     */
    ArrayList<HashMap<String, Object>> search(String query)
     ...
     * @throws NotImplementedException     the operation has not yet been implemented for this
     *                                     content source
     * @throws ContentUnavailableException the retrieval of the chapters was blocked by the
     *                                     ContentSource's website itself
     */
    ArrayList<Chapter> chapters(Series series)
     ...
     * @param quick  whether the list of chapters should be "quickly" reloaded, which ensures that
     *               only one total HTTP request is made, but does not guarantee that all chapters
     *               are loaded
     * @return a Series using the data on the series page
     * @throws IOException                 an IOException occurred when loading the series page
     * @throws NotImplementedException     the operation has not yet been implemented for this
     *                                     content source
     * @throws ContentUnavailableException the retrieval of the series was blocked by the
     *                                     ContentSource's website itself
     */
    Series series(String source, boolean quick)
            throws IOException, NotImplementedException, ContentUnavailableException;
     ...
     * initialize chapter.images with the appropriate size.
     *
     ...
     * @throws IOException                 an IOException occurred when loading the image
     * @throws ContentUnavailableException the retrieval of the image was blocked by the
     *                                     ContentSource's website itself
     * @throws NotImplementedException     the operation has not yet been implemented for this
     *                                     content source
     */
    Image image(Chapter chapter, int page)
